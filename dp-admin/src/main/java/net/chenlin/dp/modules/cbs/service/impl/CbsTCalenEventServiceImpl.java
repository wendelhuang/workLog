...
public class CbsTCalenEventServiceImpl implements CbsTCalenEventService {
	...
	@Override
	public List<CbsTCalenEventEntity> listCbsTCalenEvent(Map<String, Object> params, SysUserEntity sysUserEntity) {
		return cbsTCalenEventMapper.listCbsTCalenEvent(params.get("eventType").toString(), sysUserEntity.getUserId());
	}
