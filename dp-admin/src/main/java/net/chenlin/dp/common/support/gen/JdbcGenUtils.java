...
public class JdbcGenUtils {
	...
	public static void generatorCode(String jdbcDriver, String jdbcUrl, String jdbcUsername, String jdbcPassword,
			String tablePrefix, String javaProject, String javaModule, String webModule) throws Exception {
		...
		while (tableIterator.hasNext()) {
			...
			while (columnIterator.hasNext()) {
				...
				// 属性类型
				columnEntity.setFieldType(
						PropertiesUtils.getInstance("generator/generator").get(columnEntity.getDataType()));
		...
		for (TableEntity tableEntity : tables) {
			...
			for (String template : GenUtils.getTemplates()) {
				String filePath = getFileName(template, javaProject, javaModule, webModule, tableEntity.getClassName(),
						rootPath);
	...
	public static String getFileName(String template, String javaProject, String javaModule, String webModule,
			String className, String rootPath) {
		String packagePath = rootPath + getProjectPath(javaProject) + "/src/main/java/"
				+ PropertiesUtils.getInstance("generator/generator").get("package").replace(".", "/") + "/" + javaModule
				+ "/";
		String resourcePath = rootPath + getProjectPath(javaProject) + "/src/main/resources/"
				+ PropertiesUtils.getInstance("generator/generator").get("package").replace(".", "/") + "/" + javaModule
				+ "/";
		...
		if (template.contains(GenConstant.SQL_MENU)) {
			return rootPath + getProjectPath(javaProject) + "/src/main/resources/generator/sqls/"
